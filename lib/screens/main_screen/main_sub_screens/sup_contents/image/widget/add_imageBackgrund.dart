...
class AddImagesBackgroundDialog extends StatefulWidget {
  AddImagesBackgroundDialog({super.key});

  @override
  State<AddImagesBackgroundDialog> createState() =>
      _AddImagesBackgroundDialogState();
}

class _AddImagesBackgroundDialogState extends State<AddImagesBackgroundDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: BlocListener<ImagesBloc, FeaturDataSourceState<Images>>(
          ...
          child: SingleChildScrollView(
            ...
            ElevatedButton(
                onPressed: () {
                  ...
                  bloc.setImagesBackground(Images(image: "dd", id: "d"), file!);
                },
                child: isLoad
