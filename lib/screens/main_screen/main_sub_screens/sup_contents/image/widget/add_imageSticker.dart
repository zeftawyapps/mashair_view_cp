...
class AddImagesStickerDialog extends StatefulWidget {
  AddImagesStickerDialog({super.key });


  @override
  State<AddImagesStickerDialog> createState() => _AddImagesStickerDialogState();
}

class _AddImagesStickerDialogState extends State<AddImagesStickerDialog> {
                ...
                ElevatedButton(
                    onPressed: () {
                      ...
                      var data = form.getInputData();
                        ...
                        bloc.setImagesSticker( Images(image: "dd", id: "d") ,file!  );
