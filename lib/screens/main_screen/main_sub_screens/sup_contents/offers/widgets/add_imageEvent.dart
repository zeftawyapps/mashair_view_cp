...
class AddImageEventDialog extends StatefulWidget {
  AddImageEventDialog({super.key });


  @override
  State<AddImageEventDialog> createState() => _AddImageEventDialogState();
}

class _AddImageEventDialogState extends State<AddImageEventDialog> {
                ...
                ElevatedButton(
                    onPressed: () {
                      ...
                      var data = form.getInputData();
                        bloc.setImagesEvent( Images(image: "dd", id: "d") ,file!  );
                    },
                    child: isLoad
